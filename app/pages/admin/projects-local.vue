          ...
          <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <form class="p-5 space-y-4" @submit.prevent="onSubmit">
              ...
              <div class="pt-2 flex items-center gap-2">
                <button
                  type="submit"
                  class="h-11 flex-1 rounded-xl bg-[#0B4AA2] px-5 text-sm font-extrabold text-white shadow-sm
                         hover:bg-[#083A7E]"
                >
                  ...
                  <div class="grid sm:grid-cols-12 gap-4 p-4">
                    ...
                    <div class="sm:col-span-8">
                      ...
                      <div class="mt-4 flex items-center gap-2">
                        <button
                          type="button"
                          class="h-9 rounded-xl border border-slate-200 bg-white px-3 text-sm font-semibold hover:bg-slate-50 disabled:opacity-50"
                          :disabled="idx === 0"
                          @click="move(idx, -1)"
                        >
                          ↑ ขึ้น
